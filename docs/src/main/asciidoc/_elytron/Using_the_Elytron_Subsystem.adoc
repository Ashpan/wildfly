...
* `secret-key`: This attribute specifies the alias within the `credential-store` that contains the secret key to be used to encrypt and decrypt the realm. The default value is `key`
